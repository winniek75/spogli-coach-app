            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="hasLesson">レッスン担当（○マーク表示）</Label>
                </div>
        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            ...
            <h2 className="text-xl font-bold">
              {currentMonth.getFullYear()}年{currentMonth.getMonth() + 1}月 シフト表
            </h2>
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex flex-wrap gap-4 items-center">
            <span className="text-sm font-medium text-muted-foreground">講師:</span>
            {demoCoaches.map(coach => (
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr>
                  <th className="border p-2 bg-gray-100 text-left min-w-[150px]">シフト</th>
                  {weekends.map(date => (
                    <th 
                      key={formatDate(date)} 
              ...
              <tbody>
                ...
                <tr className="bg-orange-50">
                  <td className="border p-2 text-muted-foreground text-xs">担当コーチ</td>
                  {weekends.map(date => {
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="text-xs text-muted-foreground">今月の総シフト数</div>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="text-xs text-muted-foreground">レッスン担当</div>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="text-xs text-muted-foreground">上尾校シフト</div>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <div className="text-xs text-muted-foreground">桶川校シフト</div>
            </div>
          </CardContent>
        </Card>
      </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {editingShift.school === 'ageo' ? '上尾校' : '桶川校'}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium">{editingShift.hasLesson ? 'あり' : 'なし'}</p>
                </div>
              </div>
            </div>
            <DialogFooter>
